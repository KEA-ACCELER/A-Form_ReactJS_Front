          ...
          <FadeIn className="surveyWrapper" childClassName="childClassName">
            <div className="contentWrapper">
              ...
              <div className="postStartDate">
                <b>설문 시작 시간 : </b>
                {postData.postStartDate[0]}년 {postData.postStartDate[1]}월 {postData.postStartDate[2]}일 {postData.postStartDate[3] + TIME_ZONE}시{" "}
                {postData.postStartDate[4]}분
              </div>
              <div className="postDueDate">
                <b>설문 마감 기한 : </b>
                {postData.postDueDate[0]}년 {postData.postDueDate[1]}월 {postData.postDueDate[2]}일 {postData.postDueDate[3] + TIME_ZONE}시{" "}
                {postData.postDueDate[4]}분
              </div>
